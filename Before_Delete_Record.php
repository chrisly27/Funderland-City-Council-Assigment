...
<body>
	...
	$sql = "SELECT * FROM Funderland_Booking_Detail WHERE Booking_ID = $id ";
...
<a class="button_YES" href="Delete.php?id=<?php echo $id; ?>">YES</a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="button_NO" href="view_booking.php">NO</a><br />
	<?php echo "</div>"; ?>
	<!--footer-->
